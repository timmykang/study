...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_60 = Integer(60); _sage_const_p265 = RealNumber('.265')
import time
import primelist
import data
import reverse
...
def example(N,e):
    ...
    delta = _sage_const_p265  # this means that d < N^delta
